      ...
      <div class="main-navbar shadow-sm sticky-top">
         ...
         <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
               ...
               <div class="button text-center">
                  ...
                  <button><a href="index.php?category_view" class="nav-link text-light bg-primary my-1">Category View</a></button>
                  <button><a href="index.php?user_payments" class="nav-link text-light bg-primary my-1">User Payments</a></button>
               </div>
            </div>
         </div>
         <!-- fourth child -->
         <div class="container my-5">
            <?php
               ...
               }else if(isset($_GET['category_view'])){
               
                  include('category_view.php');
              
              
              }else if(isset($_GET['user_payments'])){
