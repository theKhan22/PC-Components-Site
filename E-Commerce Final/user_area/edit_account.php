...
<body>
   ...
   <form action="" method="post" class="text-center" enctype='multipart/form-data'>
    ...
    <div class="form-outline">
        <!--<input type="file" class="form-control w-50 m-auto mb-4" name="user_image1">-->
        <input type="file" name='user_image' class='form-control w-50 m-auto mb-4' required='required'>
    </div>
    <div class="form-outline">
...
if(isset($_POST['user_update'])){
    ...
    user_address='$user_address',user_image='$user_image',user_mobile='$user_mobile'
