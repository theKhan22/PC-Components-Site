            ...
            <div class="container-fluid">
               <div class="row">
                  ...
                  <div class="col-md-5 my-auto">
                     <form role="search" action='searching.php'>
                        <div class="input-group">
                        <form class="d-flex" action='searching.php' method='get'>
                        <input class="form-control me-2" type="search" name='search_key' placeholder="Search" aria-label="Search">
                        <input type="submit" value="Search" name='searching_data_product' class="btn btn-outline-light">
                        </form>
                        ...
                        <li class="nav-item">
                           <?php
                              ...
                              <a class='nav-link d-flex' href='#'>Welcome Guest</a>
                               ...
                               echo "<li> <a class='nav-link d-flex' href='admin_userlogin.php'>login</a></li>";
