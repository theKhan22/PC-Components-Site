...
<div class="container-fluid p-0">
    ...
    <div class="row">
        <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
            ...
            <button><a href="index.php?view_orders" class="nav-link text-light bg-info my-1">View Orders</a></button>
            <button><a href="index.php?users_view" class="nav-link text-light bg-info my-1">List Users</a></button>
